...
module.exports = (app, registryModule) =>
{
  ...
  function getDailyBalance(partnerId, date, done)
  {
    ...
    DailyBalance.findOne({partner: partnerId, date: date}).exec(function(err, dailyBalance)
    {
      if (err)
      {
        return done(err);
  ...
  function recountDailyBalance(partnerId, date, done)
  {
    ...
    step(
      function()
      {
        ...
        Ob.findOne({partner: partnerId, date: date}).select({goods: 1}).lean().exec(this.parallel());
      },
